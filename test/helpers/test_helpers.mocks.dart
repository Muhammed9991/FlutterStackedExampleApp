...
// in navigation_example_app/test/helpers/test_helpers.dart.
...
import 'package:navigation_example_app/services/age_helper_service.dart' as _i7;
...
/// A class which mocks [AgeHelperService].
///
/// See the documentation for Mockito's code generation for more information.
class MockAgeHelperService extends _i1.Mock implements _i7.AgeHelperService {
  @override
  bool isUserAbove18(String? dateOfBirth) => (super.noSuchMethod(
        Invocation.method(
          #isUserAbove18,
          [dateOfBirth],
        ),
...
/// A class which mocks [DataManagerService].
///
/// See the documentation for Mockito's code generation for more information.
class MockDataManagerService extends _i1.Mock
    implements _i8.DataManagerService {
  @override
  _i5.Future<bool> isStringDataAvailable(String? key) => (super.noSuchMethod(
        Invocation.method(
          #isStringDataAvailable,
          [key],
        ),
  ...
  @override
  _i5.Future<bool> deleteAll() => (super.noSuchMethod(
        Invocation.method(
          #deleteAll,
          [],
        ),
